...
Mobile.tap(findTestObject('Host Game (New Build with UI Changes)/android.widget.EditText0 - Give a short description about your game (optional)'), 0)
