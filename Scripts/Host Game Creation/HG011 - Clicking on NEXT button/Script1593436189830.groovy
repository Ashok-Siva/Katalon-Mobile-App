...
if(Mobile.verifyElementExist(findTestObject('Host Game (New Build with UI Changes)/android.widget.ImageView0'), 0))
{
	sheet.getRow(11).createCell(9).setCellValue("Pass");
}
else
{
	sheet.getRow(11).createCell(9).setCellValue("Fail");
}
