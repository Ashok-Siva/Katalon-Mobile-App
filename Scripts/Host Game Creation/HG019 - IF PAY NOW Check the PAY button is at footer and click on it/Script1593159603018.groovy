...
if(Mobile.verifyElementExist(findTestObject('Host Game (New Build with UI Changes)/android.widget.TextView0 - BOOK'), 0))
{
...
sheet.getRow(22).createCell(8).setCellValue("BOOK button is clicked");

sheet.getRow(22).createCell(9).setCellValue("Pass");
...
Mobile.setText(findTestObject('Host Game (New Build with UI Changes)/android.widget.EditText0 (1)'), 'sivaashok132@gmail.com', 0)
...
{
	sheet.getRow(22).createCell(9).setCellValue("Fail");
}
...
{
	sheet.getRow(22).createCell(8).setCellValue("This scenario is skipped due to selection of PAY LATER");
